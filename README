...
Download it from http://github.com/radar/nested-layouts or via Rails plugin script:
  ./script/plugin install git://github.com/Radar/nested-layouts.git

== Bugs & Feedback

Plugin originally by Маxim Kulkin (maxim.kulkin@gmail.com)

If you encounter any bugs or has some feature proposal, feel free to email it to radarlistener@gmail.com.
